...
namespace Alterian.AUTH.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "http://localhost/auth/api.svc/jsonsdk";
        ...
        public Configuration(
            ...
            string basePath = "http://localhost/auth/api.svc/jsonsdk") : this()
        {
        ...
        {
            string report = "C# SDK (Alterian.AUTH) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 6.35.0\n";
