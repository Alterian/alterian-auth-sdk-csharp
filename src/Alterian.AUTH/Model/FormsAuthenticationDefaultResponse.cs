...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FormsAuthentication_default_response")]
    public partial class FormsAuthenticationDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FormsAuthenticationDefaultResponse" /> class.
        /// </summary>
        ...
        public FormsAuthenticationDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), AuthenticationResults result = default(AuthenticationResults))
        {
        ...
        public AuthenticationResults Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FormsAuthenticationDefaultResponse {\n");
