...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetHostNames_default_response")]
    public partial class GetHostNamesDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetHostNamesDefaultResponse" /> class.
        /// </summary>
        ...
        public GetHostNamesDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<HostDetails> result = default(List<HostDetails>))
        {
        ...
        public List<HostDetails> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetHostNamesDefaultResponse {\n");
