...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCertificate_default_response")]
    public partial class GetCertificateDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCertificateDefaultResponse" /> class.
        /// </summary>
        ...
        public GetCertificateDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), Certificate result = default(Certificate))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCertificateDefaultResponse {\n");
