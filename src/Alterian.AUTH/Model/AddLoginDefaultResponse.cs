...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddLogin_default_response")]
    public partial class AddLoginDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddLoginDefaultResponse" /> class.
        /// </summary>
        ...
        public AddLoginDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), Guid result = default(Guid))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddLoginDefaultResponse {\n");
