...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetIssuers_default_response")]
    public partial class GetIssuersDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetIssuersDefaultResponse" /> class.
        /// </summary>
        ...
        public GetIssuersDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<Issuer> result = default(List<Issuer>))
        {
        ...
        public List<Issuer> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetIssuersDefaultResponse {\n");
