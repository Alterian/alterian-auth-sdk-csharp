...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetSetting_default_response")]
    public partial class GetSettingDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSettingDefaultResponse" /> class.
        /// </summary>
        ...
        public GetSettingDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), Setting result = default(Setting))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSettingDefaultResponse {\n");
