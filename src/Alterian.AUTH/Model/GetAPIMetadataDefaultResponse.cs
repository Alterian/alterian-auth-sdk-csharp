...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetAPIMetadata_default_response")]
    public partial class GetAPIMetadataDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAPIMetadataDefaultResponse" /> class.
        /// </summary>
        ...
        public GetAPIMetadataDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<APIMetadata> result = default(List<APIMetadata>))
        {
        ...
        public List<APIMetadata> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAPIMetadataDefaultResponse {\n");
