...
namespace Alterian.AUTH.Model
{
    ...
    /// OperationResult
    /// </summary>
    [DataContract(Name = "OperationResult")]
    public partial class OperationResult : IValidatableObject
    {
        /// <summary>
        ...
        public OperationResult(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor))
        {
