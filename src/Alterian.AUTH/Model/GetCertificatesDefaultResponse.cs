...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCertificates_default_response")]
    public partial class GetCertificatesDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCertificatesDefaultResponse" /> class.
        /// </summary>
        ...
        public GetCertificatesDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<Certificate> result = default(List<Certificate>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCertificatesDefaultResponse {\n");
