...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetSites_default_response")]
    public partial class GetSitesDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSitesDefaultResponse" /> class.
        /// </summary>
        ...
        public GetSitesDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<AuthSite> result = default(List<AuthSite>))
        {
        ...
        public List<AuthSite> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSitesDefaultResponse {\n");
