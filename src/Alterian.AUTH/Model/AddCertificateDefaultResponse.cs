...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddCertificate_default_response")]
    public partial class AddCertificateDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddCertificateDefaultResponse" /> class.
        /// </summary>
        ...
        public AddCertificateDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), int result = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddCertificateDefaultResponse {\n");
