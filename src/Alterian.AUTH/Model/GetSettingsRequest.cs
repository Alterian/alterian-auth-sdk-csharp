...
namespace Alterian.AUTH.Model
{
    ...
    /// GetSettingsRequest
    /// </summary>
    [DataContract(Name = "GetSettings_request")]
    public partial class GetSettingsRequest : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSettingsRequest" /> class.
        /// </summary>
        /// <param name="appliesTo">appliesTo.</param>
        /// <param name="cursor">cursor.</param>
        public GetSettingsRequest(SettingAppliesTo? appliesTo = default(SettingAppliesTo?), APICursor cursor = default(APICursor))
        {
