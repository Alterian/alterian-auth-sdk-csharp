...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Logout_default_response")]
    public partial class LogoutDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogoutDefaultResponse" /> class.
        /// </summary>
        ...
        public LogoutDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), bool result = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogoutDefaultResponse {\n");
