...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationLogin_default_response")]
    public partial class ApplicationLoginDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationLoginDefaultResponse" /> class.
        /// </summary>
        ...
        public ApplicationLoginDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), ApplicationDetails result = default(ApplicationDetails))
        {
        ...
        public ApplicationDetails Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApplicationLoginDefaultResponse {\n");
