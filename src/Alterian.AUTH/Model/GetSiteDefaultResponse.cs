...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetSite_default_response")]
    public partial class GetSiteDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSiteDefaultResponse" /> class.
        /// </summary>
        ...
        public GetSiteDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), AuthSite result = default(AuthSite))
        {
        ...
        public AuthSite Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSiteDefaultResponse {\n");
