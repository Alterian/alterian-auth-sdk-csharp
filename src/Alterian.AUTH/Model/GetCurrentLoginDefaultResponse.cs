...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCurrentLogin_default_response")]
    public partial class GetCurrentLoginDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCurrentLoginDefaultResponse" /> class.
        /// </summary>
        ...
        public GetCurrentLoginDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), LoginInfo result = default(LoginInfo))
        {
        ...
        public LoginInfo Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCurrentLoginDefaultResponse {\n");
