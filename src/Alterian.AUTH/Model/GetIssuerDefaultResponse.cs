...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetIssuer_default_response")]
    public partial class GetIssuerDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetIssuerDefaultResponse" /> class.
        /// </summary>
        ...
        public GetIssuerDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), Issuer result = default(Issuer))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetIssuerDefaultResponse {\n");
