...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetPasswordComplexityRules_default_response")]
    public partial class GetPasswordComplexityRulesDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPasswordComplexityRulesDefaultResponse" /> class.
        /// </summary>
        ...
        public GetPasswordComplexityRulesDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), PasswordComplexityRules result = default(PasswordComplexityRules))
        {
        ...
        public PasswordComplexityRules Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPasswordComplexityRulesDefaultResponse {\n");
