...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetSettings_default_response")]
    public partial class GetSettingsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSettingsDefaultResponse" /> class.
        /// </summary>
        ...
        public GetSettingsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<Setting> result = default(List<Setting>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSettingsDefaultResponse {\n");
