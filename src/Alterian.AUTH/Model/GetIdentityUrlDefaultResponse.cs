...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetIdentityUrl_default_response")]
    public partial class GetIdentityUrlDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetIdentityUrlDefaultResponse" /> class.
        /// </summary>
        ...
        public GetIdentityUrlDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), string result = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetIdentityUrlDefaultResponse {\n");
