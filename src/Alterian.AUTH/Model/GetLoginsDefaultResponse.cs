...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetLogins_default_response")]
    public partial class GetLoginsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLoginsDefaultResponse" /> class.
        /// </summary>
        ...
        public GetLoginsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<LoginInfo> result = default(List<LoginInfo>))
        {
        ...
        public List<LoginInfo> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetLoginsDefaultResponse {\n");
