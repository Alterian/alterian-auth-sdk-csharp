...
namespace Alterian.AUTH.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetSiteTypes_default_response")]
    public partial class GetSiteTypesDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSiteTypesDefaultResponse" /> class.
        /// </summary>
        ...
        public GetSiteTypesDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<AuthSiteType> result = default(List<AuthSiteType>))
        {
        ...
        public List<AuthSiteType> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSiteTypesDefaultResponse {\n");
